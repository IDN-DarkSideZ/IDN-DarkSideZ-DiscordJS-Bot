...
const { invite_channel } = require('../config.json')
    ...
    client.on('guildMemberAdd', async member => {
        ...
        try {
            ...
            const msga = new MessageEmbed()
                ...
                .setTimestamp()
            const joinchannel = member.guild.channels.cache.get(`${invite_channel}`)
            ...
            member.guild.channels.cache.get(`${invite_channel}`).send(embed)
        }
    })
}